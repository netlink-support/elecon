(function ($) {
    ...
    $(document).ready(function () {
        ...
        //         const isOpen = $this.hasClass('submenu-opened');
        ...
        //         // If it was not open before, then open it now
        //         if (isOpen) {
        ...
        $(".navigation li .submenu-button").on('click', function () {
            if ($(window).width() < 768) {

                const $this = $(this);
                const $li = $this.closest('li'); // current li
                const $submenu = $li.children('.sub-menu');
                const isOpen = $li.hasClass('active');

                // Close all others
                $('.navigation li .sub-menu').slideUp().removeClass('open');
